...
class State:
    ...
    def __init__(self, board, predecessor, move):
        """ constructs a new state object with a board object, a predecessor of
        the previous board object, the move indicating which direction is moving
        and num_moves to keep track of how many moves was made of the given 
        move.
        """
        self.board = board
    ...
    def generate_successors(self):
        ...
        for all successor states of the called State object.S
        """
        successors = []
        for m in MOVES:
            b = self.board.copy()
